...
{
    public class FormSubmissionsTabExtenderTests : UITestBase
    {
        [SetUp]
        public void Setup()
        {
        ...
        public void Export_Button_Not_Visible_With_No_Submissions()
        {
            ...
            FormHelper.EnsureNoContactFormSubmissions(WebDriver);
            // Ensure we are back at the contact form submissions
            FormHelper.GoToContactFormSubmissions(WebDriver);
        ...
        public void Export_Button_Triggers_Download_With_Submissions()
        {
            ...
            FormHelper.EnsureContactFormSubmissions(WebDriver);
            // Ensure we are back at the contact form submissions
            FormHelper.GoToContactFormSubmissions(WebDriver);
            // Find the export button
            ...
            ClassicAssert.IsTrue(files.Any(x => Path.GetFileName(x).StartsWith("Contact Us")), "No files were downloaded.");
        }
